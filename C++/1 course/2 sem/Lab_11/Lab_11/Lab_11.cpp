...
void shoose_sort_type(options result);
...
int open_menu()
{
	...
	case ShowResultOnScreen: shoose_sort_type(ShowResultOnScreen); break;
	case ShowResultInFile: shoose_sort_type(ShowResultInFile); break;
