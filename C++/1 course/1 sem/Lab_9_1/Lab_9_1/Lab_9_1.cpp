...
int open_menu()
{
	...
	switch (menu)
	{
		...
		case ShowResultOnScreen: show_result_on_screen(); break;
		case ShowResultInFile: show_result_in_file(); break;
